...
<body>
    ...
    ​
    <div class='wrapper'>
        <div class="header"><img src="https://nepalbarcouncil.org.np/wp-content/uploads/2018/11/2.jpg" width="200" height="100" alt="LOGO"> </div>
        <div class="section">
            <p>
                Hi
                <b>{{$user->name}}</b>,
                <br />
            <p>Your application form has been <span>{{ $status }}</span>.</p>
