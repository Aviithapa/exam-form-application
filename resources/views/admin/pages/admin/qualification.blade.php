                                                            ...
                                                            <div class="col-md-12 col-lg-12">
                                                                ...
                                                                @if(isset($model))
                                                                    ...
                                                                    @endphp
                                                                     ...
                                                                     <img src="{{ url($equivalence_path) }}" height="150" width="150"   id="equivalence_img">
                                                            ...
                                                            <div class="col-md-12 col-lg-12">
                                                                ...
                                                                @if(isset($model))
                                                                    ...
                                                                    @endphp
                                                                     ...
                                                                     <img src="{{ url($transcript_add_path) }}" height="150" width="150"   id="transcript_add_img">
                                                                ...
                                                                @if(isset($model))
                                                                   @php
                                                                    ...
                                                                    @endphp
                                                                     ...
                                                                     <img src="{{ url($transcript_additional_path) }}" height="150" width="150"   id="transcript_additional_img">
